/** Firebase Auth Error List
 * key is suffixed with $: for esase of finding key end / value start
 * $:* denotes a custom value (modified to our liking)
 * $:+ denotes an added property not originally listed in the list pulled from docs
 */
